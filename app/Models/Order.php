...
class Order extends Model
{
    ...
    protected $fillable = ['title', 'token', 'introduction', 'min_price', 'max_price', 'category_id', 'publishable','user_id', 'image_one', 'image_two', 'image_three', 'urgent', 'nardeban', 'delivery_date'];
    public function user()
    {
